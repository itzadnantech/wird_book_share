...
class _SeekBarState extends State<SeekBar> {
  ...
  _init_config_async() async {
    pref = await SharedPreferences.getInstance();
    test = pref.getString(LAGUAGE_CODE) ?? "ar";
  }
      ...
      children: [
        SliderTheme(
          data: _sliderThemeData.copyWith(
            ...
            activeTrackColor: Color.fromARGB(255, 97, 159, 211),
            inactiveTrackColor: Color.fromARGB(255, 169, 170, 179),
          ),
            ...
            ? Positioned(
                ...
                child: Text(
                    RegExp(r'((^0*[1-9]\d*:)?\d{2}:\d{2})\.\d+$')
                            ...
                            ?.group(1) ??
                        '$_remaining',
                    style: TextStyle(fontFamily: config.Arabic_Number_Font)
